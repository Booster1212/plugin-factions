    ...
    <div class="factions-wrapper stack">
        ...
        <div class="factions-box">
            ...
            <div class="split">
                ...
                <div>
                    <Button class="mr-2 ml-2" style="padding: 10px !important" color="green" @click="actionCreate"
                        >Create
                    </Button>
                </div>
            </div>
        </div>
        <div class="pl-1">Edit Faction:</div>
        <div style="width: 100%; overflow: auto">
            <div class="factions-box" v-for="(faction, intex) in factions">
                <div class="split">
                    ...
                    <div class="split">
                        <Button class="mr-2 ml-2" color="blue" @click="actionEdit(faction)">Edit </Button>
                        <Button class="mr-2 ml-2" color="red" @click="actionDelete(faction)">Delete </Button>
                    </div>
                </div>
            </div>
        </div>
...
import { Faction } from '@plugins/plugin-factions/shared/interfaces.js';
import { FACTION_ADMIN_EVENTS } from '../shared/factionAdminEvents.js';
import { ExampleFactionData } from './utillity/exampleFactionData.js';
...
export default defineComponent({
    ...
    methods: {
        ...
        actionCreate() {
            ...
            if (this.factionName !== '') {
                alt.emit(
                    FACTION_ADMIN_EVENTS.WEBVIEW.ACTION,
                    FACTION_ADMIN_EVENTS.PROTOCOL.CREATE_FACTION,
                    this.factionName,
                );
            }
        },
